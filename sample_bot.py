...
##Create a folder to record image
    if args.record:
...
## Object:  Car ,  AutoDriver

#Create car  :  with control_function :  send_control
    car = Car(control_function = send_control)
# Create driver to save image to folder
    ...
    #os.environ['http_proxy']='socks5://127.0.0.1:8081'
    os.environ['https_proxy']='https://127.0.0.1:8081'
    #os.environ['https_proxy']='socks5://127.0.0.1:8081'
    #from wsgiprox.wsgiprox import WSGIProxyMiddleware
